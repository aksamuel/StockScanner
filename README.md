...
- Authorized collaborators can use each exception row's Delete button to submit a GitHub removal request; the `Remove Exception` Action validates the request, updates the CSV, and republishes the page
